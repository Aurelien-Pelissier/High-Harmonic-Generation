...
%return ethaf = the ionization at time t of the first pulse, array (r,z)
...
%calculate and create a new ionization file%
    ...
    sprintf('calculating first pulse ionization file for I0=%.2e_t=%.0ffs, resolution = %d', I0,t*1e15,nres)
