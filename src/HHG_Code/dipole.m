...
%return:
%Sw2 = dipole amplitude spectrum (q) for harmonics 0 to 50
%PHI = |electron wavefunction|^2 in momentum domain (t,x)
%PSI = |electron wavefunction|^2 in space domain (t,x)
%T = time array
%X = space array
%K = momentum array
%qW2 = harmonics array
