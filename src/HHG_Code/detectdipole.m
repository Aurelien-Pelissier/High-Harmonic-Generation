...
%return the position dependent dipole response 
...
%dipqz = dipole response amplitude array (z) at time t of harmonic q
%dipqz = dipole response amplitude array (t) at position znozzle of harmonic q
%qW = harmonics array
%dipo0 = dipole response spectrum at time t and position znozzle
...
%calculating dipole response for every positions z
